...
2. Create a client-side editor/canvas wrapper that sets up the Liveblocks room.
 ...
 - 'ClientSideSuspense' with a simple loadind state.
 ...
 3. Wire React Flow to Liveblocks state.
  ...
  - pass the synced nodes, edges and changes handlers into 'ReactFlow' 
...
- Basic 'ReactFlow' rendering with minimap is visible.
- 'npm run dev' passes.