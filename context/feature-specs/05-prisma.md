Prisma ia already installed. Add the project data models, Prisma client singleton, and first migration.
...
- indexes on owner ID and creation date
 ...
 - collaborator email
 - creation timestamp
 - unique constraint on projent/email
 - indexes on email and project/date

 Don't add extra fields unless required by Prisma.
