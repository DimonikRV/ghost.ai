...
3. Wire undo and redo to Liveblocks history.
  ...
  - disabele undo when there is nothing to undo
...
4. Create a 'useKeyboardShortcuts' hook in 'hooks/'.
   ...
   - ignore shortcuts while typing in inputs, textarea, or editable text fields.
...
- don't change minimap or minimap controls

## Check When Done

- Control bar is added to the canvas.
- Zoom actions use the React Flow instnce.
- Undo and rede use Liveblocks history.
- Keyboard shortcuts are handled in 'hooks/useKeyboardShortcuts'.
- Shorycut handling skips editable fields.
