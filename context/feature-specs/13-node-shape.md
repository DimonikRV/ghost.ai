Replace the placeholder node render with proper shape rendering and a drag preview.

## Implementation

1. Replace the placeholder node shape rendering.
   - rectangle, pill, and circle should use CSS styling
   - dismond, hexagon. and cylinder should render with SVG shapes
...
2. Add a shape drag preview.
   ...
   - Nodes render the correct shape variant for each tyoe.
   ...
   - shape dragging showa a ghost preview matching the dragged shape.
